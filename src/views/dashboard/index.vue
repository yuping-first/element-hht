...
<!--            原始方法-->
<!--            <p class="lastChild">{{ $store.state.user.userInfo.company }}</p>-->
<!--            辅助函数-->
    ...
    <el-dialog
      ...
      <el-form ref="ruleForm" :model="ruleForm" label-width="110px" :rules="rules">
        <el-form-item label="离职时间" prop="end_time">
          <el-date-picker v-model="ruleForm.exceptTime" type="datetime" placeholder="选择日期时间" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
        </el-form-item>
        <el-form-item label="离职原因" prop="reason">
          <el-input v-model="ruleForm.reason" type="textarea" style="width: 70%;" placeholder="请输入内容"></el-input>
        </el-form-item>
      </el-form>
